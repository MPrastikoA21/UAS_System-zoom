        ...
        <div class="container-fluid">
            ...
            <div class="container mt-4">
              <div class="row">
                  ...
                  <div class="col-md-2">
                      <a href="/history-peminjaman"><button type="button" class="btn btn-primary float-right">History</button></a>
                  </div>
              </div>
            </div>
                    ...
                    <tbody>
                      <?php $i=1;?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/approve/{{$m->id}}"><button type="button" class="btn btn-success">Approve</button></a>
                                <a href="/deny/{{$m->id}}"><button type="button" class="btn btn-danger">Deny</button></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
