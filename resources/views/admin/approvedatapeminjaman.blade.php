...
@section('head')
    <h1 class="m-0"><strong>List Request ZOOM</strong></h1>
@endsection
        ...
        <div class="container-fluid">
            ...
            <body>
                <nav class="container mt-5 bg-white text-dark text-center">
                    <h3>APPROVE DATA REQUEST ZOOM FAKULTAS TEKNIK DAN KEJURUAN UNDIKSHA</h3>
                </nav>
            
                <div class="container mt-4">
                    <a href="/data-peminjaman"><button type="button" class="btn btn-warning">Kembali</button></a>
                </div>
                    ...
                    @foreach($peminjaman as $m)
                        <form action="/approved" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="zoom_id" name="zoom_id"  value="{{$m->zoom_id}}" >
                                ...
                                ?>
                                <input type="number" class="form-control" id="meeting_id" name="meeting_id"  value="{{ $random }}" disabled>
                                <input type="hidden" class="form-control" id="meeting_id" name="meeting_id"  value="{{ $random }}">
                                <label for="Passcode"><br/>Passcode</label>
                                <input type="number" class="form-control" id="passcode" name="passcode"  value="" >
                                <label for="Keterangan"><br/>Keterangan</label>
                                <div class="input-group">
                                    <span class="input-group-text">Keterangan</span>
                                    <textarea class="form-control" id="keterangan" name="keterangan" aria-label="keterangan" ></textarea>
                                </div>
                                ...
                                ?>
                                <input type="text" class="form-control" id="token" name="token"  value="{{ $randomString }}" disabled>
                                <input type="hidden" class="form-control" id="token" name="token"  value="{{ $randomString }}" >
                            </div>
